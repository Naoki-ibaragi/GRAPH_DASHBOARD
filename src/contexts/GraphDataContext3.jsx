...
const GraphDataContext3 = createContext();
...
export function useGraphData3() {
  const context = useContext(GraphDataContext3);
  if (!context) {
    throw new Error("useGraphData3 must be used within GraphDataProvider3");
  }
  return context;
}
