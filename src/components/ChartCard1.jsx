    ...
    <div className="w-full max-w-full">
      <div className="flex justify-end mb-4">
        <button
          ...
          className="px-6 py-2 text-sm font-medium text-primary-700 hover:text-primary-800 hover:bg-primary-50 rounded-lg transition-all duration-200 border border-primary-200"
        >
